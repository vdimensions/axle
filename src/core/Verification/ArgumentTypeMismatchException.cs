...
namespace Axle.Verification
{
    ...
    public class ArgumentTypeMismatchException : ArgumentException
    {
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Axle.ArgumentTypeMismatchException"/> class with the expected and actual type parameters
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Axle.ArgumentTypeMismatchException"/> class with the expected and actual type parameters, 
		/// the name of the parameter that causes this exception and a reference to the inner exception that is the cause of this exception.
		/// </summary>
		/// <param name="expectedType">The expected type of the argument. </param>
		/// <param name="actualType">The actual type of the argument that caused the current exception. </param>
		/// <param name="paramName">The name of the parameter that caused the current exception. </param>

...
namespace Axle.Extensions.IO.StreamReader
{
    using StreamReader = System.IO.StreamReader;

    /// <summary>
    /// A static class containing common extension methods to <see cref="StreamReader"/> instances.
    /// </summary>
    public static class StreamReaderExtensions
    {
        ...
        /// </summary>
        /// <param name="reader">The <see cref="StreamReader" /> instance that owns the stream.</param>

...
namespace Axle.Extensions
{
    public static class AttemptExtensions
    {
        public static bool Any<TResult>(this IEnumerable<Attempt<TResult>> attempts, out TResult result)
        {
            ...
            if (Enumerable.Any<Attempt<TResult>>(attempts.VerifyArgument("attempts").IsNotNull().Value, x => x(out res)))
            {
                result = res;
                return true;
            }
        ...
        {
            var res = result = default(TResult);
            if (Enumerable.Any<Attempt<T, TResult>>(attempts.VerifyArgument("attempts").IsNotNull().Value, x => x(arg, out res)))
            {
                result = res;
                return true;
            }
        ...
        {
            var res = result = default(TResult);
            if (Enumerable.Any<Attempt<T1, T2, TResult>>(attempts.VerifyArgument("attempts").IsNotNull().Value, x => x(arg1, arg2, out res)))
            {
                result = res;
                return true;
            }
        ...
        {
            var res = result = default(TResult);
            if (Enumerable.Any<Attempt<T1, T2, T3, TResult>>(attempts.VerifyArgument("attempts").IsNotNull().Value, x => x(arg1, arg2, arg3, out res)))
            {
                result = res;
                return true;
            }
        ...
        {
            var res = result = default(TResult);
            if (Enumerable.Any<Attempt<T1, T2, T3, T4, TResult>>(attempts.VerifyArgument("attempts").IsNotNull().Value, x => x(arg1, arg2, arg3, arg4, out res)))
            {
                result = res;
                return true;
            }
        ...
        {
            TResult result;
            return attempt.VerifyArgument ("attempt").IsNotNull ().Value.Invoke (out result) ? result : defaultValue;
        }
        public static TResult Invoke<T, TResult>(this Attempt<T, TResult> attempt, T arg, TResult defaultValue)
        {
            TResult result;
            return attempt.VerifyArgument ("attempt").IsNotNull ().Value.Invoke (arg, out result) ? result : defaultValue;
        }
        public static TResult Invoke<T1, T2, TResult>(this Attempt<T1, T2, TResult> attempt, T1 arg1, T2 arg2, TResult defaultValue)
        {
            TResult result;
            return attempt.VerifyArgument("attempt").IsNotNull().Value.Invoke(arg1, arg2, out result) ? result : defaultValue;
        }
        ...
        {
            TResult result;
            return attempt.VerifyArgument("attempt").IsNotNull().Value.Invoke(arg1, arg2, arg3, out result) ? result : defaultValue;
        }
        ...
        {
            TResult result;
            return attempt.VerifyArgument("attempt").IsNotNull().Value.Invoke(arg1, arg2, arg3, arg4, out result) ? result : defaultValue;
        }

        public static Optional<TResult> Invoke<TResult>(this Attempt<TResult> attempt)
        {
            TResult result;
            return attempt.VerifyArgument("attempt").IsNotNull().Value.Invoke(out result) ? Optional.From(result) : Optional<TResult>.Undefined;
        }
        public static Optional<TResult> Invoke<T, TResult>(this Attempt<T, TResult> attempt, T arg)
        {
            TResult result;
            return attempt.VerifyArgument("attempt").IsNotNull().Value.Invoke(arg, out result) ? Optional.From(result) : Optional<TResult>.Undefined;
        }
        public static Optional<TResult> Invoke<T1, T2, TResult>(this Attempt<T1, T2, TResult> attempt, T1 arg1, T2 arg2)
        {
            TResult result;
            return attempt.VerifyArgument("attempt").IsNotNull().Value.Invoke(arg1, arg2, out result) ? Optional.From(result) : Optional<TResult>.Undefined;
        }
        public static Optional<TResult> Invoke<T1, T2, T3, TResult>(this Attempt<T1, T2, T3, TResult> attempt, T1 arg1, T2 arg2, T3 arg3)
        {
            TResult result;
            return attempt.VerifyArgument("attempt").IsNotNull().Value.Invoke(arg1, arg2, arg3, out result) ? Optional.From(result) : Optional<TResult>.Undefined;
        }
        ...
        {
            TResult result;
            return attempt.VerifyArgument("attempt").IsNotNull().Value.Invoke(arg1, arg2, arg3, arg4, out result) ? Optional.From(result) : Optional<TResult>.Undefined;
        }
    }
}
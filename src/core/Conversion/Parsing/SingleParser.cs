...
{
    /// <summary>
    /// A class that can parse <see cref="string">string</see> representations of a <see cref="float">single precision floating point number</see> to a valid <see cref="float"/> value.
    /// </summary>
#if !netstandard
    [Serializable]
#endif

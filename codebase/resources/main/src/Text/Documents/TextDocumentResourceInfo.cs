...
namespace Axle.Resources.Text.Documents
{
    ...
    public abstract class TextDocumentResourceInfo : ResourceInfo
    {
        ...
        protected TextDocumentResourceInfo(string name, CultureInfo culture, string mimeType, IDictionary<string, string> data) : base(name, culture, mimeType)
        {
            _data = data;
        }
        protected TextDocumentResourceInfo(string name, CultureInfo culture, string mimeType, IDictionary<string, string> data, ResourceInfo originalResource) : this(name, culture, mimeType, data)
        {

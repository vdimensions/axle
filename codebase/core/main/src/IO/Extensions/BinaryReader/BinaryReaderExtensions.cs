...
namespace Axle.IO.Extensions.BinaryReader
{
    ...
    {
        /// <summary>
        /// Sets the position within the <see cref="BinaryReader.BaseStream">underlying stream</see> of the
        /// <see cref="BinaryReader" />.
        /// </summary>
        /// <param name="reader">
        /// The <see cref="BinaryReader" /> instance that owns the stream.
        /// </param>
        /// <param name="offset">
        ...
        /// </param>
        /// <returns>
        /// The new position within the <see cref="BinaryReader.BaseStream">underlying stream</see> of the
        /// <see cref="BinaryReader" />.
        /// </returns>
        ...
        /// The <see cref="BinaryReader.BaseStream">underlying stream</see> of the <see cref="BinaryReader" /> does not
        /// support seeking, 
        /// such as if the stream is constructed from a pipe or console output. 
        /// </exception>
        /// <exception cref="System.ObjectDisposedException">
        /// Methods were called after the <see cref="BinaryReader" /> or its
        /// <see cref="BinaryReader.BaseStream">underlying stream</see> were closed. 
        /// </exception>

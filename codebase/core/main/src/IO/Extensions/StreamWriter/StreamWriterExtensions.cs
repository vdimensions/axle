...
namespace Axle.IO.Extensions.StreamWriter
{
    ...
    {
        /// <summary>
        /// Sets the position within the <see cref="StreamWriter.BaseStream">underlying stream</see> of the
        /// <see cref="StreamWriter" />.
        /// </summary>
        /// <param name="writer">
        /// The <see cref="StreamWriter" /> instance that owns the stream.
        /// </param>
        /// <param name="offset">
        ...
        /// </param>
        /// <returns>
        /// The new position within the <see cref="StreamWriter.BaseStream">underlying stream</see> of the
        /// <see cref="StreamWriter" />.
        /// </returns>
        ...
        /// The <see cref="StreamWriter.BaseStream">underlying stream</see> of the <see cref="StreamWriter" /> does not
        /// support seeking, such as if the stream is constructed from a pipe or console output. 
        /// </exception>
        /// <exception cref="System.ObjectDisposedException">
        /// Methods were called after the <see cref="StreamWriter" /> or its
        /// <see cref="StreamWriter.BaseStream">underlying stream</see> were closed. 
        /// </exception>

...
namespace Axle.Verification
{
    ...
    public static class Verifier
    {
        ...
        /// <typeparamref name="T"/>. 
        /// </param>
        /// <exception cref="ArgumentNullException">The represented by the <paramref name="argument"/> parameter object
        ...
        /// </param>
        /// <param name="comparer">
        /// An reference to the <see cref="IEqualityComparer{T}"/> instance that will be used to determine the 
        /// equality.
        /// </param>
        /// <param name="message">
        /// An error message to be passed to the exception in case the verification fails.

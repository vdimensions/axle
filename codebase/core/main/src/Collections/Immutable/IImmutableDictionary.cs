...
namespace Axle.Collections.Immutable
{
    ...
    {
        /// <summary>
        /// Retrieves an empty dictionary that has the same ordering and key/value comparison rules as this dictionary
        /// instance.
        /// </summary>
        /// <returns>
        ...
        /// </param>
        /// <returns>
        /// A new immutable dictionary with the specified element removed; or this instance if the specified key cannot
        /// be found in the dictionary.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// <see langword="true" /> if the specified key/value pair is found in the dictionary;
        ...
        /// The matching key located in the dictionary if found, or <c>equalkey</c> if no match is found.
        /// </param>
        /// <returns>
        /// <see langword="true" /> if a match for <paramref name="equalKey" /> is found;
        /// otherwise, <see langword="false" />.
        /// </returns>

namespace Axle.Reflection
{
    ...
    public interface ICastOperator
    {
        ...
        /// <see cref="ICastOperator">cast operator</see> instance.
        /// </returns>
        object Invoke(object target);

        /// <summary>
        /// Attempts to invoke the cast operation represented by the current 
        /// <see cref="ICastOperator">cast operator</see> instance on the <paramref name="target"/> object.
        /// </summary>
        /// <param name="target">
        /// The target object to be cast.
        /// </param>
        ...
        /// <summary>
        /// Determines if the current <see cref="ICastOperator">cast operator</see> is defined by the target 
    ...
    /// <see cref="ICastOperator{T1,T2}">cast operator</see>.</typeparam>
    /// <typeparam name="T2">
    ...
    public interface ICastOperator<T1, T2> : ICastOperator
    {
        ...
        /// the current <see cref="ICastOperator{T1, T2}">cast operator</see> instance.
        /// </returns>
        T2 Invoke(T1 target);
        /// <summary>
        /// Attempts to invoke the cast operation represented by the current 
        /// <see cref="ICastOperator{T1, T2}">cast operator</see> instance on the <paramref name="target"/> object.
        /// </summary>
        /// <param name="target">
        /// The target object to be cast.
        /// </param>
        /// <param name="result">
        /// An instance of <typeparamref name="T2"/> that is the result of the cast operation represented by 
        /// the current <see cref="ICastOperator">cast operator</see> instance.
        /// </param>
        /// <returns>

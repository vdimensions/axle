...
namespace Axle.Extensions.Object
{
    ...
    public static class ObjectExtensions
    {
        ...
        /// constrain you in any way to pass external and potentially un-related objects that will be used to obtain the
        /// resulting hash. Be advised to carefully choose the arguments when performing calls to this method, as it
        /// serves more as a convenient shortcut to manually doing the hash calculation.
        /// </remarks>
        /// <typeparam name="T">
        ...
        /// Its own <see cref="object.GetHashCode()"/> method is not invoked inside this method, only the hashes of the
        ...
        /// </param>
        /// <param name="args">
        /// An array of objects, usually the key members of the target <paramref name="obj"/> that will participate in
        /// calculating the final hash code.
        /// </param>
        /// <returns>
        /// An integer representing the hash code as a combined value of the hashes from the objects passed in trough

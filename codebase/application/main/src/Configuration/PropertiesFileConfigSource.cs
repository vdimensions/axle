...
{
    internal sealed class PropertiesFileConfigSource : IConfigSource
    {
        ...
        public PropertiesFileConfigSource(string fileName, IConfigurationStreamProvider configStreamProvider, string env)
        {
        ...
        public PropertiesFileConfigSource(string fileName, IConfigurationStreamProvider configStreamProvider) 

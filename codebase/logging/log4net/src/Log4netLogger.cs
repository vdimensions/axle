...
namespace Axle.Logging.Log4net
{
    ...
    internal sealed class Log4netLogger : Axle.Logging.ILogger
    {
        ...
        void Axle.Logging.ILogger.Write(ILogEntry entry)
        {
        ...
        Type Axle.Logging.ILogger.TargetType => _targetType;
        #endregion
    }
}